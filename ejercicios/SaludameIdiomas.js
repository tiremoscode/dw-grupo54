...
function Es(name) { console.log('Hola ' + name); }

function Ing(name) { console.log('Hello ' + name); }

function French(name) { console.log('Bonjour ' + name); }

function Italiano(name) { console.log('Ciao ' + name); }
